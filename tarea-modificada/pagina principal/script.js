...
const totalCarrito = document.getElementById('total');  // Elemento para mostrar el total
const contadorCarrito = document.getElementById('contador-carrito');  // Elemento para mostrar el contador
